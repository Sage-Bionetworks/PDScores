...
## Generated on : Wed Feb 11 19:13:03 2015
...
OBJS = bridge_ufb_rtwutil.o bridge_ufb_data.o bridge_ufb_initialize.o bridge_ufb_terminate.o extractaudiophon.o fastdfa.o features_bga.o features_bpa.o features_bta.o features_bvav2.o features_ufb.o lomb.o mfcc.o swipep.o vadsplitphon.o abs.o rdivide.o mean.o combine_vector_elements.o log2.o power.o sortrows.o log10.o polyfit.o sqrt.o repmat.o diff.o sum.o quantile.o round.o median.o iqr.o var.o atan2.o primes.o interp1.o flip.o spline.o pwchcore.o flipud.o polyval.o bridge_ufb_emxutil.o bridge_ufb_emxAPI.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
