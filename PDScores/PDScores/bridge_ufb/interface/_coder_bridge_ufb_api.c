...
static void e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *gait, const
  char_T *identifier, emxArray_real_T *y);
...
static void g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *tap, const
  char_T *identifier, emxArray_real_T *y);
static void h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, emxArray_real_T *y);
static const mxArray *f_emlrt_marshallOut(const real_T u[2]);
static real_T i_emlrt_marshallIn(const emlrtStack *sp, const mxArray *srate,
...
void features_bga_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  ...
  /* Marshall function inputs */
  e_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "gait", gait);
  ...
  char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  f_emlrt_marshallIn(sp, emlrtAlias(gait), &thisId, y);
...
void features_bpa_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  ...
  /* Marshall function inputs */
  e_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "post", post);
...
void features_bta_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  ...
  /* Marshall function inputs */
  g_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "tap", tap);
  ...
  char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  h_emlrt_marshallIn(sp, emlrtAlias(tap), &thisId, y);
...
void features_bvav2_api(const mxArray *prhs[2], const mxArray *plhs[1])
{
  ...
  srate = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "srate");
  ...
  const char_T *identifier)
{
  ...
  thisId.fIdentifier = identifier;
  thisId.fParent = NULL;
  y = j_emlrt_marshallIn(sp, emlrtAlias(srate), &thisId);
...
void features_ufb_api(const mxArray *prhs[7], const mxArray *plhs[1])
{
  ...
  /* Marshall function inputs */
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "ftvec", ftvec);
  emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "wvec", wvec);
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "ilog", ilog);
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "ftmin", ftmin);
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[4]), "ftmax", ftmax);
  fbmin = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "fbmin");
  fbmax = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "fbmax");
...
void lomb_api(const mxArray *prhs[4], const mxArray *plhs[3])
{
  ...
  ofac = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "ofac");
  hifac = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "hifac");
...
void swipep_api(const mxArray *prhs[8], const mxArray *plhs[3])
{
  ...
  fs = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "fs");
  plim = k_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "plim");
  dt = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "dt");
  dlog2p = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "dlog2p");
  dERBs = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "dERBs");
  woverlap = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "woverlap");
  sTHR = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[7]), "sTHR");
